/**
 * Just a place to store any reusable functions we might need across different tests.
 ...
 * - Anything to help us generate random data for tests.
 */

/**
 * Wipes the events from localStorage. We run this before each test to ensure a clean state.
